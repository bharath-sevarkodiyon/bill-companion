      ...
      <section className="w-full max-w-md">
        <div className="flex items-center gap-3 mb-8 justify-center">
          <div className="h-11 w-11 rounded-xl bg-deep-navy flex items-center justify-center">
            <img src="/logo.png" alt="Logo" className="text-primary-foreground" />
          </div>
          <h1 className="text-2xl font-bold text-ink">BILL EXTRACTOR</h1>
        </div>

        <div className="bg-mist rounded-xl p-8 shadow-[var(--shadow-card)]">
          <h2 className="text-center text-xl font-semibold text-ink mb-2">
